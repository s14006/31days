 ...
 * core.start();
 */
var nineleap_image_path = "../images/";
(function() {

    /**
     * @type {Object}
     */
    enchant.nineleap = { assets: [nineleap_image_path + 'start.png', nineleap_image_path + 'end.png'] };
    ...
    enchant.nineleap.Core = enchant.Class.create(enchant.Core, {
        ...
        initialize: function(width, height) {
            ...
            this.addEventListener('load', function() {
                ...
                this.startScene.image = this.assets[nineleap_image_path + 'start.png'];
                ...
                this.endScene.image = this.assets[nineleap_image_path + 'end.png'];
