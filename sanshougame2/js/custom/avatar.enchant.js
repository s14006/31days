...
enchant.avatar.AvatarBG = enchant.Class.create(enchant.Group, {
    ...
    initialize: function(mode) {
        ...
        this.veryfarbg.y = 0;
        this.veryfarbg.image = core.assets[avatar_image_path + "avatarBg2.png"];
        this.veryfarbg.frame = mode;
        this.addChild(this.veryfarbg);
        this.farbgs = [];
        for (i = 0; i < 3; i++) {
            var bg = new enchant.Sprite(320, 32);
            bg.image = core.assets[avatar_image_path + "avatarBg3.png"];
            bg.frame = mode;
            bg.x = i * 320 - 320;
            bg.y = 20;
        ...
        for (i = 0; i < 14; i++) {
            ...
            tile.image = core.assets[avatar_image_path + "avatarBg1.png"];
            tile.frame = mode;
            tile.x = i * 31 - 48;
            tile.y = 48;
