 ...
 */
enchant.ui = { assets: [
	ui_image_path + 'pad.png'
	, ui_image_path + 'apad.png'
	, ui_image_path + 'icon0.png'
	, ui_image_path + 'font0.png'
] };
...
enchant.ui.Pad = enchant.Class.create(enchant.Sprite, {
    ...
    initialize: function() {
        ...
        var image = core.assets[ui_image_path + 'pad.png'];
...
enchant.ui.APad = enchant.Class.create(enchant.Group, {
    ...
    initialize: function(mode) {
        var core = enchant.Core.instance;
        var image = core.assets[ui_image_path + 'apad.png'];
...
enchant.ui.MutableText = enchant.Class.create(enchant.Sprite, {
    ...
    setText: function(txt) {
        ...
        for (i = 0; i < txt.length; i++) {
            ...
            this.image.draw(enchant.Game.instance.assets[ui_image_path +'font0.png'],
